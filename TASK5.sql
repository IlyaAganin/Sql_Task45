...
семестров проучился студент вычислять из года поступления и текущей даты – написать для этого функцию). 
Должны выводиться поля: код студента, ФИО студента, курс, код предмета, название предмета, семестр, оценка 
